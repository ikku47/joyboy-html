...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={[invert ? 'black' : '#d792ff']} />
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <Text  font="/Inter-Medium.woff" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#d792ff'}>
        JoyBoy.ae
      </Text>
    </Screen>
  )
...
function ScreenInteractive(props) {
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={['#d792ff']} />
